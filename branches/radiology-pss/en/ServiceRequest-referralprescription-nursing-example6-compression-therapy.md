# Example 6: Compression therapy - Digital Referral Prescription Implementation Guide v1.0.0

## Example ServiceRequest: Example 6: Compression therapy
...
**code**: Application of anti-embolic stockings
...
```json
{
  ...
  "id" : "referralprescription-nursing-example6-compression-therapy",
  "meta" : {
