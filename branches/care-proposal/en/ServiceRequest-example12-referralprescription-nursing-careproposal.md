# Example 12: Care proposal (Annex 81) - Digital Referral Prescription Implementation Guide v1.0.0

## Example ServiceRequest: Example 12: Care proposal (Annex 81)

Profile: [CareProposal](StructureDefinition-care-proposal.md)
...
```json
{
  ...
  "id" : "example12-referralprescription-nursing-careproposal",
  "meta" : {
    "profile" : ["https://www.ehealth.fgov.be/standards/fhir/drp/StructureDefinition/care-proposal"]
  },
  "extension" : [{
