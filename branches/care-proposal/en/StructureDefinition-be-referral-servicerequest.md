...
### Common referral prescription model

`BeReferralServiceRequest` is the **common referral prescription model** — the shared structure that every referral prescription builds on. Specific use cases (a [care proposal](StructureDefinition-care-proposal.md), a telemonitoring request, a re-order) are expressed as **specializations** that derive from it and add only their own rules.

See the [Data models](datamodels.md) page for the full model hierarchy and how the specializations relate.

**Usages:**

* Derived from this Profile: [BeReferralServiceRequestNursing](StructureDefinition-be-referral-servicerequest-nursing.md), [BeReferralServiceRequestTelemonitoring](StructureDefinition-be-referral-servicerequest-telemonitoring.md) and [CareProposal](StructureDefinition-care-proposal.md)
