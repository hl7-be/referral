# Example 5: Digestive System Care - Digital Referral Prescription Implementation Guide v1.0.0

## Example ServiceRequest: Example 5: Digestive System Care
...
```json
{
  ...
  "id" : "referralprescription-nursing-example5-digestive-system-care",
  "meta" : {
