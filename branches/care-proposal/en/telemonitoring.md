# Telemonitoring - Digital Referral Prescription Implementation Guide v1.0.0
...
RemoteMonitoringPrescription as a specialization of BeReferralPrescription
...
* **Inline extension** ([BeReferralServiceRequestTelemonitoring](StructureDefinition-be-referral-servicerequest-telemonitoring.md)) — all monitoring rules live in a repeating extension on the ServiceRequest itself. Best for per-patient prescriptions with unique rules.
* **PlanDefinition reference** ([BeReferralServiceRequestTelemonitoringPlanned](StructureDefinition-be-referral-servicerequest-telemonitoring-planned.md)) — the rules live in a referenced PlanDefinition. Best for reusable monitoring protocols applied to many patients.
