...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/be-cs-care-proposal-status-reason"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/BeModelTelemonitoringPrescription"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/be-referral-servicerequest-telemonitoring"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/be-ext-telemonitoring-plan"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/be-vs-care-proposal-reason-code"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/be-vs-care-proposal-status-reason"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/care-proposal"
      },
      "name" : "CareProposal",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/be-vs-body-laterality"
      },
      "name" : "DRP Body Laterality",
    ...
    },
    {
      ...
      "name" : "DRP Diabetic Education Type",
    ...
    },
    {
      ...
      "name" : "DRP Glycemia Measurement Timing",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ServiceRequest/example12-referralprescription-nursing-careproposal"
      },
      "name" : "Example 12: Care proposal (Annex 81)",
      "description" : "Care proposal (Annex 81)",
      "exampleCanonical" : "https://www.ehealth.fgov.be/standards/fhir/drp/StructureDefinition/care-proposal"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    "page" : {
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "datamodels.html"
        }],
        "nameUrl" : "datamodels.html",
        "title" : "Data Models",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "telemonitoring.html"
        }],
        "nameUrl" : "telemonitoring.html",
