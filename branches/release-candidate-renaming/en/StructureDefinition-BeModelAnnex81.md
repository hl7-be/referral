# BeModelAnnex81 - Referral Prescription Implementation Guide v1.0.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.be.referral|current/StructureDefinition/StructureDefinition-BeModelAnnex81.json)
