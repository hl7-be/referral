# BeModelTreatmentStatus - Referral Prescription Implementation Guide v1.0.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.be.referral|current/StructureDefinition/StructureDefinition-BeModelTreatmentStatus.json)
...
```json
{
  ...
  "url" : "https://www.ehealth.fgov.be/standards/fhir/referral/StructureDefinition/BeModelTreatmentStatus",
  "version" : "1.0.0",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "https://www.ehealth.fgov.be/standards/fhir/referral/StructureDefinition/BeModelTreatmentStatus",
