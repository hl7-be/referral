# BeVSAnnex81StatusReason - Referral Prescription Implementation Guide v1.0.0
...
```json
{
  ...
  "compose" : {
    "include" : [{
      "system" : "https://www.ehealth.fgov.be/standards/fhir/referral/CodeSystem/be-cs-annex81-status-reason"
    }]
  }
}
