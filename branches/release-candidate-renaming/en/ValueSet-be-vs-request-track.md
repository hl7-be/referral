# eReferral request track - Referral Prescription Implementation Guide v1.0.0

## ValueSet: eReferral request track 

 
Allowed request tracks. Extends the official Belgian request track value set with UHMEP-specific codes. 
...
```json
{
  ...
  "url" : "https://www.ehealth.fgov.be/standards/fhir/referral/ValueSet/be-vs-request-track",
  "version" : "1.0.0",
