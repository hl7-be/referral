# BeVSPrescriptionStatusReason - Referral Prescription Implementation Guide v1.0.0
...
```json
{
  ...
  "url" : "https://www.ehealth.fgov.be/standards/fhir/referral/ValueSet/be-vs-prescription-status-reason",
  "version" : "1.0.0",
