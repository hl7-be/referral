# BeServiceRequestDiagnosticImaging - Referral Prescription Implementation Guide v1.0.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.be.referral|current/StructureDefinition/StructureDefinition-be-referral-servicerequest-diagnosticimaging.json)
...
```json
{
  ...
  "url" : "https://www.ehealth.fgov.be/standards/fhir/referral/StructureDefinition/be-referral-servicerequest-diagnosticimaging",
  "version" : "1.0.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "profile" : ["https://www.ehealth.fgov.be/standards/fhir/referral/StructureDefinition/be-imaging-attention-conditions-response"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://www.ehealth.fgov.be/standards/fhir/referral/StructureDefinition/be-ext-urgency-justification"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://www.ehealth.fgov.be/standards/fhir/referral/StructureDefinition/be-ext-pss-info"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://www.ehealth.fgov.be/standards/fhir/referral/ValueSet/be-vs-request-track"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://www.ehealth.fgov.be/standards/fhir/referral/ValueSet/be-vs-imaging-priority"
      }
    },
    {
    ...
    },
    {
      ...
      "slicing" : {
        "discriminator" : [{
          "type" : "value",
          "path" : "extension('https://www.ehealth.fgov.be/standards/fhir/referral/StructureDefinition/be-ext-radiology-supporting-info-role').value"
        }],
        "rules" : "open"
      }
    },
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://www.ehealth.fgov.be/standards/fhir/referral/StructureDefinition/be-ext-codeable-concept"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "binding" : {
        "strength" : "preferred",
        "valueSet" : "https://www.ehealth.fgov.be/standards/fhir/referral/ValueSet/be-vs-imaging-modality"
      }
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://www.ehealth.fgov.be/standards/fhir/referral/StructureDefinition/be-imaging-attention-conditions-response"]
      }],
      "mustSupport" : true
    },
    {
