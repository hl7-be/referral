# BeReferralTask - Referral Prescription Implementation Guide v1.0.0
...
* Examples for this Profile: [Task/example-referral-task](Task-example-referral-task.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.be.referral|current/StructureDefinition/StructureDefinition-be-referral-task.json)
...
```json
{
  ...
  "id" : "be-referral-task",
  "url" : "https://www.ehealth.fgov.be/standards/fhir/referral/StructureDefinition/be-referral-task",
  "version" : "1.0.0",
  "name" : "BeReferralTask",
  "status" : "active",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        ...
        "valueSet" : "https://www.ehealth.fgov.be/standards/fhir/referral/ValueSet/be-vs-treatment-status-reason"
      }
    },
    {
      "id" : "Task.intent",
