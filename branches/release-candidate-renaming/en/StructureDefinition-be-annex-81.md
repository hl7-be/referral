# BeAnnex81 - Referral Prescription Implementation Guide v1.0.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.be.referral|current/StructureDefinition/StructureDefinition-be-annex-81.json)
...
```json
{
  ...
  "id" : "be-annex-81",
  "url" : "https://www.ehealth.fgov.be/standards/fhir/referral/StructureDefinition/be-annex-81",
  "version" : "1.0.0",
  "name" : "BeAnnex81",
  "status" : "active",
  ...
  "differential" : {
    "element" : [{
      ...
      "constraint" : [{
        ...
        "source" : "https://www.ehealth.fgov.be/standards/fhir/referral/StructureDefinition/be-annex-81"
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://www.ehealth.fgov.be/standards/fhir/referral/StructureDefinition/be-annex-81"]
      }],
      "mustSupport" : true
    },
    {
