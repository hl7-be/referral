# BeTreatmentStatusReason - Referral Prescription Implementation Guide v1.0.0
...
```json
{
  ...
  "url" : "https://www.ehealth.fgov.be/standards/fhir/referral/CodeSystem/be-treatment-status-reason",
  "version" : "1.0.0",
  ...
  "count" : 3,
  "concept" : [{
    "code" : "stopped-temporarily",
    "display" : "Stopped temporarily"
  },
  {
    "code" : "blacklisted-caregiver",
