# eReferral Note Type - Digital Referral Prescription Implementation Guide v1.0.0

## ValueSet: eReferral Note Type 

 
Types of notes that can be associated with a referral prescription. 
