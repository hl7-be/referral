# eReferral Prescription Type - Digital Referral Prescription Implementation Guide v1.0.0

## CodeSystem: eReferral Prescription Type 
...
* [BeVSAnnex81TechnicalType](ValueSet-be-vs-annex81-technical-type.md)
* [BeVSNursingPrescriptionTechnicalType](ValueSet-be-vs-nursing-prescription-technical-type.md)
...
```json
{
  ...
  },
  {
    ...
    {
      "language" : "fr-BE",
      "value" : "Ã‰ducation au diabète dans un trajet de soins"
    }]
  },
  {
    ...
    {
      "language" : "fr-BE",
      "value" : "Ã‰ducation au diabète dans un trajet de démarrage"
    }]
  },
  {
    ...
    {
      "language" : "fr-BE",
      "value" : "Ã‰ducation au diabète pour les patients sans trajectoire"
    }]
  },
  {
    ...
    {
      "language" : "fr-BE",
      "value" : "Ã‰ducation au diabète dans un centre de convention"
    }]
  },
  {
    "code" : "glycemic-test",
    ...
    {
      "language" : "fr-BE",
      "value" : "ContrÃ´le glycémique avec glucomètre"
    }]
  },
  {
  ...
  },
  {
    ...
    "display" : "Diagnostic imaging (Appendix 82)",
    "designation" : [{
      "language" : "nl-BE",
      "value" : "Diagnostische beeldvorming (Bijlage 82)"
    },
    {
      "language" : "fr-BE",
      "value" : "Imagerie Médicale (Annex 82)"
    }]
  }]
}
