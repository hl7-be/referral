# BeLatestEndDate - Digital Referral Prescription Implementation Guide v1.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.be.drp|current/StructureDefinition/StructureDefinition-be-ext-latest-end-date.json)
