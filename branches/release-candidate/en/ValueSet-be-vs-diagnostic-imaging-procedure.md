# eReferral/PSS Diagnostic Imaging Procedure - Digital Referral Prescription Implementation Guide v1.1.0
...
```json
{
  ...
  "compose" : {
    "include" : [{
      ...
      {
        "code" : "241589001",
        "display" : "Computed tomography myelography with contrast (procedure)"
      },
      {
        "code" : "241590005",
        "display" : "Computed tomography cervical myelography with contrast (procedure)"
      },
      {
        "code" : "241591009",
        "display" : "Computed tomography thoracic myelography with contrast (procedure)"
      },
      {
        "code" : "241592002",
        "display" : "Computed tomography lumbar myelography with contrast (procedure)"
      },
      {
        "code" : "431326009",
      ...
      {
        "code" : "418394000",
        "display" : "Ultrasonography of abdomen and pelvis (procedure)"
      },
      {
        "code" : "47079000",
