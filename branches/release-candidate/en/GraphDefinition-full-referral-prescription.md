# BeGDFullReferralPrescription - Digital Referral Prescription Implementation Guide v1.1.0
...
**url**: [GraphDefinition FullReferralPrescription](GraphDefinition-full-referral-prescription.md)
