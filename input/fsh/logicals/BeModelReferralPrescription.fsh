...
* recordedDate 1..1 http://hl7.org/fhir/StructureDefinition/dateTime "When this prescription was created" "When this prescription was created"
...
* co-prescriber.co-prescriberType 0..1 http://hl7.org/fhir/StructureDefinition/code "Type of the practitioner" "Type of the practitioner"
* co-prescriber.status 0..1 http://hl7.org/fhir/StructureDefinition/code "Status of co prescribing status (to sign, signed or refused)" "Status of co prescribing status (to sign, signed or refused)"
...
* prescriptionNumber 0..1 http://hl7.org/fhir/StructureDefinition/Identifier "An identifier for the ReferralPrescription, e.g. the UHMEP identifier, once available" "An identifier for the ReferralPrescription, e.g. the UHMEP identifier, once available"
...
* validitionPeriod 1..1 http://hl7.org/fhir/StructureDefinition/Period "Period of validity of prescription" "Period of validity of prescription"
* treatmentPeriod 0..1 http://hl7.org/fhir/StructureDefinition/Period "When this prescription is executed, available after start of execution" "When this prescription is executed, available after start of execution"
...
* supportingInfo 0..1 Reference "Care Set Problem"
...
* status 0..1 http://hl7.org/fhir/StructureDefinition/code "Current status" "Current status"
...
* bodySite 0..* http://hl7.org/fhir/StructureDefinition/CodeableConcept "Anatomical place where the treatment should be executed"
