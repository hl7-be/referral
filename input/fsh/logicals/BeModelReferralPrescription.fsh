...
* continuationOf 0..* Identifier "Continuation of care: reference to the previous prescription that this one prolongs, continues or supersedes. Maps to ServiceRequest.replaces (distinct from originRequestId, which maps to basedOn)." "Continuation of care: reference to the previous prescription that this one prolongs, continues or supersedes. Maps to ServiceRequest.replaces (distinct from originRequestId, which maps to basedOn)."
