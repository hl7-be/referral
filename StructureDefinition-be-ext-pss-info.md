...
| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/drp/StructureDefinition/be-ext-pss-info | *Version*:1.0.0 |
| Draft as of 2026-03-23 | *Computable Name*:BePSSInfo |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.be.drp|current/StructureDefinition/be-ext-pss-info)
